...
import { Save, AlertCircle, Settings, Dices, Coins, Cherry, Spades, Disc, Percent } from 'lucide-react';
...
export default function GamblingSettingsPage() {
  ...
  const tabs = [
    ...
    { id: 'blackjack', label: 'ブラックジャック', icon: Spades },
              ...
              <div className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    ...
                    <RechartsTooltip 
                      formatter={(value: number) => [`${(value * 100).toFixed(2)}%`, '確率']}
...
os.makedirs(r"C:\Users\kakij\OneDrive\ドキュメント\多様化bot\dashboard\src\app\dashboard\[guild_id]\gambling", exist_ok=True)
with open(r"C:\Users\kakij\OneDrive\ドキュメント\多様化bot\dashboard\src\app\dashboard\[guild_id]\gambling\page.tsx", 'w', encoding='utf-8') as f:
    f.write(content)
