...
DEFAULT_SETTINGS = {
    ...
    "GAMBLE_CHINCHIRO_RATE_PINZORO": 0.02,
    "GAMBLE_CHINCHIRO_RATE_ARASHI": 0.05,
    "GAMBLE_CHINCHIRO_RATE_SHIGORO": 0.08,
    "GAMBLE_CHINCHIRO_RATE_NORMAL_WIN": 0.295,
    "GAMBLE_CHINCHIRO_RATE_HIFUMI": 0.11,
    "GAMBLE_CHINCHIRO_RATE_LOSE": 0.445,
    "GAMBLE_CHINCHIRO_MUL_PINZORO": 5.0,
    "GAMBLE_CHINCHIRO_MUL_ARASHI": 3.0,
    "GAMBLE_CHINCHIRO_MUL_SHIGORO": 2.0,
    "GAMBLE_CHINCHIRO_MUL_HIFUMI": -2.0,
    "GAMBLE_CHINCHIRO_MUL_NORMAL": 1.0,
    "GAMBLE_COINFLIP_RATE_WIN": 0.475,
    "GAMBLE_COINFLIP_RATE_LOSE": 0.525,
    "GAMBLE_COINFLIP_MUL": 2.0,
    "GAMBLE_SLOT_RATE_7": 0.002,
    "GAMBLE_SLOT_RATE_STAR": 0.002,
    "GAMBLE_SLOT_RATE_THREE": 0.012,
    "GAMBLE_SLOT_RATE_TWO": 0.328,
    "GAMBLE_SLOT_MUL_7": 10.0,
    "GAMBLE_SLOT_MUL_STAR": 5.0,
    "GAMBLE_SLOT_MUL_THREE": 3.0,
    "GAMBLE_SLOT_MUL_TWO": 1.5,
    "GAMBLE_BLACKJACK_RATE_NORMAL_WIN": 0.38,
    "GAMBLE_BLACKJACK_RATE_BJ_WIN": 0.05,
    "GAMBLE_BLACKJACK_RATE_DRAW": 0.09,
    "GAMBLE_BLACKJACK_RATE_LOSE": 0.48,
    "GAMBLE_BLACKJACK_MUL_NORMAL": 2.0,
    "GAMBLE_BLACKJACK_MUL_BJ": 2.5,
    "GAMBLE_ROULETTE_WIN_RATE_2X": 0.475,
    "GAMBLE_ROULETTE_WIN_RATE_3X": 0.316,
    "GAMBLE_ROULETTE_WIN_RATE_36X": 0.0264,
    "GAMBLE_ROULETTE_MUL_2X": 2.0,
    "GAMBLE_ROULETTE_MUL_3X": 3.0,
...
def is_admin_or_banker():
    async def predicate(interaction: discord.Interaction):
        if not interaction.guild:
            return False
        if has_admin_role(interaction.client, interaction.user) or has_banker_role(interaction.client, interaction.user):
            return True
        await interaction.response.send_message("このコマンドを実行する権限がありません（運営または銀行員専用です）。", ephemeral=True)
        return False
    return app_commands.check(predicate)
