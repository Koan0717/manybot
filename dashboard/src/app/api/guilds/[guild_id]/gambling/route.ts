...
const SETTING_KEYS = [
  ...
  'GAMBLE_TAX_RATE',
  'GAMBLE_SHOW_STATS',
  'GAMBLE_CHINCHIRO_SHOW_STATS',
  'GAMBLE_COINFLIP_SHOW_STATS',
  'GAMBLE_SLOT_SHOW_STATS',
  'GAMBLE_BLACKJACK_SHOW_STATS',
  'GAMBLE_ROULETTE_SHOW_STATS',
  'GAMBLE_HORSE_SHOW_STATS',
  'GAMBLE_HIGHLOW_SHOW_STATS',
  ...
  'GAMBLE_HORSE_RATE_WIN_TAN',
  'GAMBLE_HORSE_RATE_WIN_FUKU',
  'GAMBLE_HORSE_MUL_TAN',
  'GAMBLE_HORSE_MUL_FUKU',
  'GAMBLE_HIGHLOW_RATE_WIN',
  'GAMBLE_HIGHLOW_RATE_DRAW',
  'GAMBLE_HIGHLOW_RATE_LOSE',
  'GAMBLE_HIGHLOW_MUL',
  'GAMBLE_HIGHLOW_MAX_STREAK',
  'GAMBLE_HIGHLOW_STREAK_MULS',
  'GAMBLE_HIGHLOW_STREAK_WIN_RATES'
];
