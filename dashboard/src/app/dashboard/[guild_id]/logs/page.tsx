...
const LOG_TYPES = [
  ...
  { id: 'member_transfer', label: 'アクティビティ・Webからの送金（未設定・OFFなら「経済システム・通貨変動」に送信）' },
  { id: 'member_transfer_public', label: 'アクティビティ・Webからの送金（お知らせ：/pay と同じ「💵 @相手 に ○○ を送金しました。」をメンバー向けに送信）' },
