...
const pool = new Pool({ connectionString: 'postgresql://postgres.nxvdvrebqjrzxcxfrpun:Kakijun06100717@aws-1-ap-northeast-1.pooler.supabase.com:6543/postgres?sslmode=require' });
async function run() {
    try {
        await pool.query(`
